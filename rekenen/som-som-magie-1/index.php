            ...
            <div class="col">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            <div class="col"></div>
                            <div class="col"><input id="opl_B2" type="text" class="form-control text-center" value="?" disabled></div>
                            <div class="col"><input id="opl_C2" type="text" class="form-control text-center" value="?" disabled></div>
                            <div class="col"><input id="inp_D2" type="text" class="form-control text-center" value="18"></div>
                        </div>
                        <div class="row mt-3">
                            <div class="col"></div>
                            <div class="col"><input id="opl_B3" type="text" class="form-control text-center" value="?" disabled></div>
                            <div class="col"><input id="opl_C3" type="text" class="form-control text-center" value="?" disabled></div>
