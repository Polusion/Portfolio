...
const antwoord_input = document.getElementById("antwoord_input")
const som_antwoord = document.getElementById("som_antwoord")
...
function checkAnswer() {
    const correctAnswer = antwoord_input.value == som_antwoord.textContent

    antwoord_input.classList.remove(correctAnswer? "is-invalid": "is-valid")
    antwoord_input.classList.add(correctAnswer? "is-valid": "is-invalid")
